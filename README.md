...
- Current SE hooks cover Start, dialogue advance, choice decide, dialogue
  ...
  increases.
- BGM and full 3D model replacement are not implemented in this pass.
...
- The guild receptionist has a one-NPC glTF prototype using Quaternius CC0
  runtime files in `assets/models/characters/guild_receptionist/`.
