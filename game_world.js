...
Object.assign(DIALOGUES, {
  admin_permit_office: {
    speaker: "許可局の窓口係",
    lines: [
      "王城区、港湾、辺境砦、学院の一部施設。行き先ごとに許可は別です。同じ紙で全部は通れません。",
      "仮登録者は自由申請できません。保証人、依頼書、照会記録。最低でもその三つが揃ってからです。",
      "ここは門ではありません。扉の前で、あなたがどの扉に近づけるかを仕分ける場所です。"
    ]
  },
  admin_record_window: {
    speaker: "記録官補佐",
    lines: [
      "通行、宿泊、商会信用、ギルド登録。王都内の記録は別々に見えて、最後は照合されます。",
      "あなたの記録はまだ薄い。森の街道、商会紹介状、北門通行、ギルド申請……空白のほうが多いですね。",
      "便利になるほど、行動履歴も残ります。王都で暮らすとは、そういうことです。"
    ]
  },
  admin_guard_post: {
    speaker: "警備詰所の衛兵",
    lines: [
      "王城区方面は正式な呼び出しか許可が必要だ。近道を探すだけなら、この通りで引き返せ。",
      "行政通りだからといって役所だけじゃない。家も店もある。だから余計に、騒ぎは記録に残る。"
    ]
  },
  admin_royal_gate: {
    speaker: "王城区方面の門",
    lines: [
      "門の向こうへ続く坂道は衛兵に塞がれている。呼び出し状、上位許可、同行者のいずれかが必要らしい。",
      "今はまだ、ここから王城区本体へは進めない。掲示には『申請は許可局へ』とある。"
    ]
  },
  admin_queue_citizen: {
    speaker: "許可申請に並ぶ市民",
    lines: [
      "港へ荷物を出すだけでも用途欄が違うんだ。商会の印があれば早いが、ないと半日待ちさ。",
      "列の横に住んでる家もある。朝はパンの匂い、昼は書類の愚痴。ここもちゃんと街なんだよ。"
    ]
  },
  admin_runner: {
    speaker: "王城区方面へ向かう使い走り",
    lines: [
      "通してくれ、呼び出しの控えを届けるだけだ。……ああ、君は並ぶ側か。なら窓口で記録を作るところからだね。",
      "王城区へ行ける者は少ない。でも、この通りには誰でも来る。紙と噂はここを通るから。"
    ]
  },
  admin_vendor: {
    speaker: "屋台の店主",
    lines: [
      "温かい豆煮だよ。許可待ちの列には、飯とインクと諦めがよく売れる。",
      "役所のそばにも暮らしはある。むしろ人が待たされる場所ほど、小商いは育つのさ。"
    ]
  },
  admin_lost_traveler: {
    speaker: "書類をなくした旅人",
    lines: [
      "紹介状の控えをなくしたかもしれない。いや、宿に置いたか、商会で出したか……記録官に聞けば分かるかな。",
      "便利な街だよ。なくした物まで記録から探せる。代わりに、なくした事実も残るけどね。"
    ]
  },
  admin_notice: {
    speaker: "行政通りの掲示板",
    lines: [
      "『王城区通行、港湾搬入、辺境砦派遣、学院施設立入は用途別許可とする』",
      "『仮登録者の単独申請は保証人または依頼書を要する』",
      "掲示の下には、宿屋、代書屋、軽食屋、井戸の場所を示す小さな案内も貼られている。"
    ]
  }
});

Object.assign(DIALOGUES, {
  market_lodging_resident: {
    speaker: "市場帰りの住民",
    lines: [
      "広場から少し入るだけで、宿屋、商会、住宅、裏路地が混ざる。王都は区画名より、人の用事で道が決まるんだ。",
      "市場だけを見て帰る旅人は迷いやすいよ。泊まる場所、荷を預ける場所、抜け道を聞く場所が全部近いからね。"
    ]
  },
  market_lodging_traveler: {
    speaker: "宿屋へ向かう旅人",
    lines: [
      "曲がった匙亭に部屋を取るつもりだ。商会の紹介状があると、宿帳の確認も少し早いらしい。",
      "便利な街だよ。だが便利な分だけ、どこで泊まり、誰と取引したかも残る。"
    ]
  },
  market_lodging_porter: {
    speaker: "商会の荷運び人",
    lines: [
      "商会へ行くなら荷車に気をつけろ。市場通りは人だけじゃなく、樽も箱も記録も流れてくる。",
      "この先に事務所がある。信用があれば奥の扉も開くが、今は受付で話を通すのが先だな。"
    ]
  },
  market_lodging_alley_warn: {
    speaker: "裏路地を警戒する市民",
    lines: [
      "宿屋の裏手から細い道へ入れる。近道ではあるが、用がないなら明るい通りを歩きな。",
      "裏路地にも暮らしはある。悪党だけの場所じゃない。だが、記録に残らない話をしたい連中も集まる。"
    ]
  },
  market_lodging_merchant: {
    speaker: "記録窓口帰りの商人",
    lines: [
      "許可局で待ったあとにここへ来ると、豆煮の匂いだけで救われるよ。",
      "王城区、港湾、商会、宿屋。別々の用事に見えて、王都では帳簿の上でつながっている。"
    ]
  },
  market_lodging_notice: {
    speaker: "市場通りの掲示板",
    lines: [
      "『宿屋は夜間の身元照合に協力すること。商会荷の預かりは帳簿番号を添えること』",
      "掲示の端に、中央広場、曲がった匙亭、エドリック商会、裏路地への簡単な案内が描かれている。"
    ]
  }
});
...
let caravanThreat = null, trainingTrial = null;
...
function isOutdoorMap() { return state.map === "plaza" || state.map === "forestRoad" || state.map === "trainingGround" || state.map === "academyCampus" || state.map === "churchGrounds" || state.map === "backstreet" || state.map === "administrativeStreet" || state.map === "marketLodgingStreet"; }
...
function initialSpawn(map) { return ({ forestRoad: { x: 0, z: 74 }, plaza: { x: 0, z: 610 }, guildHall: { x: 0, z: 6.2 }, church: { x: 0, z: 5.5 }, churchGrounds: { x: 0, z: 48 }, trainingGround: { x: 0, z: 48 }, academy: { x: 0, z: 9 }, academyCampus: { x: 0, z: 50 }, inn: { x: 0, z: 5.4 }, backstreet: { x: 0, z: 18 }, merchantOffice: { x: 0, z: 7 }, administrativeStreet: { x: 0, z: 54 }, marketLodgingStreet: { x: 0, z: 54 } })[map] || { x: 0, z: 74 }; }
...
function loadMap(id, spawn) {
  ...
  ({ forestRoad: buildForestRoad, plaza: buildCity, guildHall: buildGuildHall, church: buildChurch, trainingGround: buildTrainingGround, academy: buildAcademy, academyCampus: buildAcademyCampus, churchGrounds: buildChurchGrounds, inn: buildInn, backstreet: buildBackstreet, merchantOffice: buildMerchantOffice, administrativeStreet: buildAdministrativeStreet, marketLodgingStreet: buildMarketLodgingStreet }[id] || buildForestRoad)();
...
function buildAdministrativeStreet() {
  setEnv(0xb8c7d2, 55, 760);
  bounds = { minX: -64, maxX: 64, minZ: -88, maxZ: 64 };
  ground(140, 170, 0x6f8a52, "grass");
  road(0, -8, 16, 142, 0x807668);
  road(0, -24, 112, 10, 0x756d60);
  road(-38, 16, 7, 70, 0x6b6255, "dirt");
  road(34, 26, 7, 48, 0x6b6255, "dirt");
  house(-24, -40, 25, 17, 12, 0x7a6a5a, "PERMIT", true, faceToward(1, 0));
  house(24, -38, 25, 17, 12, 0x6a6458, "RECORDS", true, faceToward(-1, 0));
  house(-45, 2, 19, 14, 9, 0x6a5e52, "POST", true, faceToward(1, 0));
  house(43, 12, 16, 12, 8, 0x8a6547, "INK", false, faceToward(-1, 0));
  house(-46, 38, 16, 12, 8, 0x75624e, null, false, faceToward(1, 0));
  house(44, 42, 17, 12, 8.5, 0x83684d, "ROOMS", false, faceToward(-1, 0));
  box(0, 4, -78, 38, 8, 6, 0x6d6c64, "royalGate", world, true);
  box(-16, 11, -78, 7, 18, 10, 0x74736b, "tower", world, true);
  box(16, 11, -78, 7, 18, 10, 0x74736b, "tower", world, true);
  addSign(0, -72, "王城区方面（許可制）");
  addSign(-24, -29, "許可局 窓口");
  addSign(24, -27, "記録官 窓口");
  addSign(-45, 11, "警備詰所");
  addQuestBoard(-4, 28);
  addSign(-4, 24, "許可掲示");
  stall(34, 28, 0xd8b36b);
  well(-34, 44);
  for (const [bx, bz] of [[-10, 12], [0, 12], [10, 12], [-10, 18], [0, 18], [10, 18]]) bench(bx, bz, Math.PI / 2);
  for (const [cx, cz, n] of [[-54, -18, 3], [50, -14, 2], [-18, 36, 3], [26, 44, 2]]) crates(cx, cz, n);
  for (const [bx, bz] of [[-52, 24], [50, 38], [38, -8]]) barrel(bx, bz);
  for (const [lx, lz] of [[-10, 52], [10, 52], [-8, -58], [8, -58], [-45, -16], [45, -12]]) lamp(lx, lz);
  addNpc("traveler", -10, 15, 0x7f9fbd, "許可申請に並ぶ市民", "admin_queue_citizen");
  addNpc("noble", -18, -35, 0xd8c89a, "許可局の窓口係", "admin_permit_office");
  addNpc("noble", 18, -34, 0xd2c39a, "記録官補佐", "admin_record_window");
  addNpc("guard", -42, 2, 0xb77954, "警備詰所の衛兵", "admin_guard_post");
  addNpc("traveler", 7, -58, 0x8c7b5b, "王城区方面へ向かう使い走り", "admin_runner");
  addNpc("merchant", 36, 30, 0x9a6f54, "屋台の店主", "admin_vendor");
  addNpc("traveler", -32, 42, 0x6f8aa6, "書類をなくした旅人", "admin_lost_traveler");
  locations.push(
    { id: "admin_exit", name: "中央広場へ戻る", x: 0, z: 58, r: 5, targetMap: "plaza", spawn: { x: -34, z: -78 } },
    { id: "permit_office", name: "許可局の窓口で話を聞く", x: -18, z: -35, r: 3.4, dialogue: "admin_permit_office" },
    { id: "record_window", name: "記録官窓口で照会する", x: 18, z: -34, r: 3.4, dialogue: "admin_record_window" },
    { id: "guard_post", name: "警備詰所の衛兵と話す", x: -42, z: 2, r: 3.4, dialogue: "admin_guard_post" },
    { id: "royal_gate", name: "王城区方面の門を見る", x: 0, z: -72, r: 6, dialogue: "admin_royal_gate" },
    { id: "admin_notice", name: "許可掲示を読む", x: -4, z: 28, r: 3, dialogue: "admin_notice" }
  );
}
function buildMarketLodgingStreet() {
  setEnv(0xb9d1dc, 48, 720);
  bounds = { minX: -72, maxX: 72, minZ: -88, maxZ: 66 };
  ground(152, 178, 0x6f8a52, "grass");
  road(0, -6, 18, 140, 0x807668);
  road(0, 6, 122, 10, 0x756d60);
  road(-42, 28, 7, 62, 0x6b6255, "dirt");
  road(42, 24, 7, 54, 0x6b6255, "dirt");
  road(0, 44, 92, 5.5, 0x6b6255, "dirt");

  house(-30, -36, 26, 18, 13, 0x7b5a3d, "INN ROAD", true, faceToward(1, 0));
  house(30, -36, 26, 18, 13, 0x7a6148, "TRADE", true, faceToward(-1, 0));
  house(-50, 14, 17, 12, 8.5, 0x75624e, "ROOMS", false, faceToward(1, 0));
  house(50, 18, 17, 12, 9, 0x85664a, "BREAD", false, faceToward(-1, 0));
  house(-48, 44, 18, 12, 8, 0x6d5d4a, null, false, faceToward(1, 0));
  house(46, 46, 18, 12, 8.5, 0x8a6547, "HERB", false, faceToward(-1, 0));

  stall(-18, 8, 0xd8b36b);
  stall(18, 9, 0x3f815a);
  stall(38, 30, 0xc8763a);
  well(-34, 48);
  addQuestBoard(0, 26);
  addSign(0, 22, "MARKET NOTICE");
  addSign(0, 58, "CENTRAL PLAZA");
  addSign(-34, -24, "INN");
  addSign(34, -24, "TRADE HOUSE");
  addSign(-50, 30, "BACKSTREET");
  addSign(50, 34, "LODGINGS");

  for (const [cx, cz, n] of [[-56, -18, 3], [55, -16, 3], [-22, 20, 4], [24, 24, 3], [-48, 52, 2], [50, 50, 2]]) crates(cx, cz, n);
  for (const [bx, bz] of [[-55, 28], [54, 34], [30, -8], [-24, -8], [4, 34]]) barrel(bx, bz);
  for (const [lx, lz] of [[-10, 52], [10, 52], [-8, -58], [8, -58], [-45, 4], [45, 6]]) lamp(lx, lz);
  for (const [bx, bz] of [[-12, 33], [12, 33], [-26, 40], [26, 40]]) bench(bx, bz, Math.PI / 2);
  for (const [hx, hz] of [[-56, 36], [56, 40]]) {
    cyl(hx - 2, 1.4, hz, .12, 2.8, 0x5a3a22);
    cyl(hx + 2, 1.4, hz, .12, 2.8, 0x5a3a22);
    box(hx, 2.25, hz, 4.4, .08, .08, 0x3a2a1c);
    box(hx, 1.55, hz, 3.4, .08, .9, 0xd8c2a0);
  }

  addNpc("traveler", -8, 15, 0x7f9fbd, "市場帰りの住民", "market_lodging_resident");
  addNpc("traveler", -26, -24, 0x8c7b5b, "宿屋へ向かう旅人", "market_lodging_traveler");
  addNpc("merchant", 26, -20, 0x9a6f54, "商会の荷運び人", "market_lodging_porter");
  addNpc("traveler", -44, 26, 0x6f8aa6, "裏路地を警戒する市民", "market_lodging_alley_warn");
  addNpc("merchant", 36, 20, 0x8a6a44, "記録窓口帰りの商人", "market_lodging_merchant");

  locations.push(
    { id: "market_lodging_exit", name: "中央広場へ戻る", x: 0, z: 58, r: 5, targetMap: "plaza", spawn: { x: 78, z: -34 } },
    { id: "market_lodging_inn", name: "宿屋 曲がった匙亭へ入る", x: -30, z: -30, r: 5, targetMap: "inn", spawn: { x: 0, z: 5.4 } },
    { id: "market_lodging_merchant", name: "エドリック商会へ向かう", x: 30, z: -30, r: 5, targetMap: "merchantOffice", spawn: { x: 0, z: 7 } },
    { id: "market_lodging_backstreet", name: "裏路地へ入る", x: -50, z: 31, r: 5, targetMap: "backstreet", spawn: { x: 0, z: 18 } },
    { id: "market_lodging_notice", name: "市場通りの掲示を見る", x: 0, z: 26, r: 3, dialogue: "market_lodging_notice" }
  );
}
...
function addTrainingTarget(x, z, kind = "practice") {
  const g = new THREE.Group();
  g.position.set(x, 0, z);
  world.add(g);
  const color = kind === "mock" ? 0x87c7ff : 0xd8b36b;
  cyl(0, .75, 0, .32, 1.5, kind === "mock" ? 0x5f708a : 0x7a5635, "", g);
  box(0, 1.55, 0, 1.35, .16, .16, color, "", g);
  const marker = makeThreatMarker(kind === "mock" ? "MOCK RIVAL" : "TRAINING TARGET", color);
  marker.position.set(0, 0, 0);
  marker.scale.setScalar(kind === "mock" ? .9 : .72);
  g.add(marker);
  return { obj: g, marker, x, z, r: kind === "mock" ? 1.25 : 1.05, hp: kind === "mock" ? 2 : 1, maxHp: kind === "mock" ? 2 : 1, kind, active: true };
}
function buildTrainingGround() {
  setEnv(0x88a6b4, 25, 180);
  bounds = { minX: -60, maxX: 60, minZ: -70, maxZ: 70 };
  ground(130, 150, 0x556c4c);
  road(0, 0, 18, 130, 0x776b5a);
  for (let i = 0; i < 16; i++) cyl(rand(-35, 35), .85, rand(-40, 40), .25, 1.7, 0x7a5635, "target");
  trainingTrial = { practiceHits: 0, targets: [], mock: null };
  for (const [tx, tz] of [[-24, -18], [0, -24], [24, -18]]) trainingTrial.targets.push(addTrainingTarget(tx, tz, "practice"));
  trainingTrial.mock = addTrainingTarget(10, -8, "mock");
  if (done("mock_battle")) trainingTrial.mock.active = false;
  addSign(0, 48, "TO CAPITAL");
  placeModelNpc("guard", "guard", -8, 12, 0xb77954, "訓練教官", "training", { map: "trainingGround" });
  addNpc("adventurer", 10, -8, 0x6f8aa6, "模擬戦相手", "mock_battle");
  locations.push({ id: "practice", name: "火球制御を練習する", x: -8, z: 12, r: 4, dialogue: "training" }, { id: "mock", name: "翌日の模擬戦を受ける", x: 10, z: -8, r: 4, dialogue: "mock_battle" }, { id: "training_exit", name: "王都へ戻る", x: 0, z: 52, r: 4, targetMap: "plaza", spawn: { x: 360, z: 305 } });
}
...
// #51 裏路地: 狭い路地/井戸/洗濯物/木箱・樽/市民NPC/裏口・行き止まり。王都の生活感の小区画。
function buildBackstreet() {
  setEnv(0x9aa6ad, 30, 360); bounds = { minX: -22, maxX: 22, minZ: -30, maxZ: 22 };
  ground(50, 64, 0x6a6052, "dirt");
  road(0, -4, 7, 52, 0x6b6255, "dirt"); // 細い路地
  for (let z = -26; z <= 16; z += 8) {
    house(-15, z, 9, 7, rand(6, 9), pick([0x7b5a3d, 0x6d5d4a, 0x83684d]), null, false, faceToward(1, 0));
    house(15, z + 4, 9, 7, rand(6, 9), pick([0x83684d, 0x7b5a3d, 0x6d5d4a]), null, false, faceToward(-1, 0));
  }
  well(-4, -8); // 井戸・水場
  for (const [hx, hz] of [[-8, 2], [7, -10], [-7, -18]]) { cyl(hx, 1.8, hz, .04, .1, 0x4a3320, "", world); for (let i = 0; i < 4; i++) { const c = box(hx + .6 + i * .5, 1.5, hz, .4, .5, .04, pick([0xc8c2b0, 0xb44a5a, 0x4a86c0, 0x5fae6a]), "", world); c.rotation.z = .04; } } // 洗濯物
  for (let i = 0; i < 5; i++) crates(rand(-12, 12), rand(-24, 14), Math.floor(rand(2, 4)));
  for (let i = 0; i < 3; i++) barrel(rand(-11, 11), rand(-22, 12));
  lamp(-6, -2); lamp(6, -14); brazier(9, 6);
  addSign(0, 18, "裏路地 / BACK STREET");
  box(0, 1.4, -28, 6, 2.8, .6, 0x3a2c20, "deadend", world, true); addSign(0, -25, "行き止まり");
  box(-19, 1.4, -10, .6, 2.8, 3, 0x4a3320, "backdoor", world, true); addSign(-19, -7, "裏口(施錠)");
  // 市民NPC(生活感) + 情報屋(alley進行を維持)
  addNpc("slum", -4, -3, 0x4f4238, "路地の住人", "alley_warn");
  addNpc("traveler", 4, -1, 0x7f6f8d, "井戸端の女", "alley_guild");
  addNpc("slum", -6, -16, 0x5d4b39, "古株の住人", "alley_church");
  addNpc("merchant", 6, 8, 0x9a6f54, "路地の小商人", "alley_market");
  addNpc("slum", 8, -20, 0x4a4038, "声をひそめる男", "alley_watch");
  addNpc("slum", 0, -10, 0x6a5a4a, "路地裏の男", "alley");
  locations.push(
    { id: "alley", name: "情報屋に接触する", x: 0, z: -10, r: 3, dialogue: "alley" },
    { id: "backstreet_well", name: "井戸の水場を見る", x: -4, z: -8, r: 2.6, dialogue: "backstreet" },
    { id: "backstreet_exit", name: "大通りへ戻る", x: 0, z: 20, r: 2.4, targetMap: "plaza", spawn: { x: -390, z: 235 } }
  );
}
...
// #50 北門詰所: 検問カウンター/記録机/武器棚/待機ベンチ/衛兵詰所/事情聴取室 を門前に配置。
// north_gate の進行(merchant/gate, 紹介状必須, progress_guard/north_gate_check)は不変。
function gateCheckpoint(gx, gz) {
  const z0 = gz + 8; // 検問エリアは門の手前(+z側)
  box(gx - 6, .6, z0, 5, 1.2, 1.2, 0x6a5a3f, "checkpoint", world, true);   // 検問カウンター
  box(gx + 7, .55, z0 + 1, 3, 1.1, 1.6, 0x5a4632, "deskRec", world, true); // 記録机
  box(gx - 13, 1.1, z0 + 2, 1, 2.2, 4, 0x4a3a2a, "rack", world, true);     // 武器棚/装備置き場
  for (let i = 0; i < 3; i++) { const sp = cyl(gx - 12.6, 1.2, z0 + .8 + i * 1.2, .05, 2.2, 0x6e5134, "", world); sp.rotation.z = .05; }
  bench(gx + 12, z0 + 3, 0); bench(gx + 12, z0 + 5, 0);                     // 待機ベンチ
  house(gx - 24, z0 + 4, 16, 12, 7, 0x6a5e52, "GATE POST", true, faceToward(0, -1)); // 衛兵詰所
  addSign(gx - 24, z0 - 2.5, "衛兵詰所");
  box(gx + 21, 2, z0 + 6, 8, 4, 8, 0x5e564a, "office", world, true); addSign(gx + 21, z0 + 1, "事情聴取室"); // 小部屋
  lamp(gx - 8, z0); lamp(gx + 9, z0);
  addNpc("noble", gx + 7, z0 + 2.4, 0xd8c89a, "記録係", "gate_record");
  addNpc("guard", gx - 6, z0 - 1.4, 0xb77954, "検問の衛兵", "north_gate");
  locations.push(
    { id: "gate_record", name: "記録机で記帳を確認する", x: gx + 7, z: z0 + 1, r: 3, dialogue: "gate_record" },
    { id: "gate_notice", name: "詰所の掲示を読む", x: gx - 24, z: z0 - 2.5, r: 3, dialogue: "gate_notice" }
  );
}
...
function addCaravan(x, z) { const g = cart(); g.position.set(x, 0, z); g.rotation.y = -.22; world.add(g); addNpc("merchant", x + .8, z + 1.4, 0x6f8aa6, "商人", done("merchant") ? "caravan_after" : "caravan_attack"); if (!done("merchant")) { const beast = createBeast(); const bx = x + 4.35, bz = z - .9; beast.position.set(bx, 0, bz); beast.rotation.y = -Math.PI / 2; world.add(beast); const marker = makeThreatMarker("BITE-HOUND", 0xff5a3a); marker.position.set(bx, 0, bz); world.add(marker); caravanThreat = { obj: beast, marker, x: bx, z: bz, r: 1.4, hp: 3, maxHp: 3, active: true, hitFlash: 0 }; updateThreatHp(marker, 3, 3); cull(beast, bx, bz, 420); cull(marker, bx, bz, 620); } addCollider(x, z, 4.2, 3.4, "caravan"); cull(g, x, z, 500); }
function makeThreatMarker(text = "TARGET", color = 0xff5a3a) {
  const g = new THREE.Group();
  const ring = add(new THREE.TorusGeometry(1.35, .085, 8, 28), mat(color, .4, color, 1.5), g);
  ring.rotation.x = Math.PI / 2; ring.position.y = .12; g.userData.ring = ring;
  const beam = add(coneGeo(.46, 1, 5), mat(color, .35, color, 1.8), g);
  beam.position.y = 2.05; beam.rotation.x = Math.PI; g.userData.beam = beam;
  box(0, 2.62, 0, 1.7, .11, .08, 0x241414, "", g);
  const hp = box(0, 2.63, 0, 1.55, .08, .1, color, "", g);
  g.userData.hpFill = hp;
  const lab = label(text);
  lab.position.set(0, 2.95, 0); lab.scale.set(1.8, .48, 1); g.add(lab);
  return g;
}
function updateThreatHp(marker, hp, maxHp) {
  const fill = marker?.userData?.hpFill;
  if (!fill) return;
  const pct = THREE.MathUtils.clamp(maxHp ? hp / maxHp : 0, 0, 1);
  fill.scale.x = pct;
  fill.position.x = -(1 - pct) * .775;
}
...
function damageCaravanThreat(damage = 1) {
  if (!caravanThreat?.active) return;
  caravanThreat.hp = Math.max(0, (caravanThreat.hp || 1) - damage);
  caravanThreat.hitFlash = .28;
  updateThreatHp(caravanThreat.marker, caravanThreat.hp, caravanThreat.maxHp || 3);
  if (caravanThreat.hp > 0) {
    showSystemToast("HOUND STAGGERED", `Black bite-hound HP ${caravanThreat.hp}/${caravanThreat.maxHp || 3}`);
    return;
  }
  resolveCaravanRescue();
}
function completeTrainingPractice(target) {
  if (!target?.active) return;
  target.active = false;
  target.obj.visible = false;
  trainingTrial.practiceHits = (trainingTrial.practiceHits || 0) + 1;
  if (!done("training")) {
    markDone(["training"]);
    addTrust({ Guild: 2 });
    data.objective = "翌日の模擬戦を受ける";
    showSystemToast("TRAINING LOGGED", "Fireball control was recorded in the guild training ledger.");
  } else {
    showSystemToast("TARGET HIT", "Training target neutralized.");
  }
  updateHud();
}
function resolveMockBattleFromArena() {
  if (done("mock_battle")) return;
  markDone(["mock_battle"]);
  addTrust({ Guild: 6 });
  setDeep("player.rank", "F級冒険者");
  data.objective = "西の魔法学院を訪ね、入学相談をする";
  if (trainingTrial?.mock) {
    trainingTrial.mock.active = false;
    updateThreatHp(trainingTrial.mock.marker, 0, trainingTrial.mock.maxHp || 2);
  }
  showSystemToast("MOCK BATTLE CLEARED", "Control, survival, and restraint were added to the guild record.");
  updateHud();
}
function hitTrainingTarget(pos, radius = .35, damage = 1) {
  if (state.map !== "trainingGround" || !trainingTrial || pos.y > 3.2) return false;
  for (const t of trainingTrial.targets || []) {
    if (!t.active || Math.hypot(pos.x - t.x, pos.z - t.z) > t.r + radius) continue;
    t.hp = Math.max(0, t.hp - damage);
    updateThreatHp(t.marker, t.hp, t.maxHp);
    if (t.hp <= 0) completeTrainingPractice(t);
    return true;
  }
  const mock = trainingTrial.mock;
  if (!mock?.active || done("mock_battle") || Math.hypot(pos.x - mock.x, pos.z - mock.z) > mock.r + radius) return false;
  if (!done("training")) {
    showSystemToast("CONTROL REQUIRED", "Hit a training target before the mock battle.");
    return true;
  }
  mock.hp = Math.max(0, mock.hp - damage);
  updateThreatHp(mock.marker, mock.hp, mock.maxHp);
  if (mock.hp <= 0) resolveMockBattleFromArena();
  else showSystemToast("MOCK RIVAL STAGGERED", `Mock battle HP ${mock.hp}/${mock.maxHp}`);
  return true;
}
function resolveCaravanRescue() {
  ...
  showSystemToast("商人救助 / RESCUE COMPLETE", "商人エドリックを噛み犬から救った。『助かった……今の魔法は何だ。ともかく、礼だ』——商会の紹介状を受け取り、商会の信用(Merchant Trust +5)が上がった。これは身分証ではなく、商会の信用を借りた一時通行の証。北門でこれを示せば、王都へ入れる。");
  updateHud();
}
function updateEffects(dt) {
  ...
  if (caravanThreat?.active && caravanThreat.marker) { caravanThreat.hitFlash = Math.max(0, (caravanThreat.hitFlash || 0) - dt); const t = clock.elapsedTime, pulse = 1 + Math.sin(t * 4.2) * .15 + caravanThreat.hitFlash * 1.2; const mk = caravanThreat.marker; if (mk.userData.ring) mk.userData.ring.scale.set(pulse, pulse, 1); if (mk.userData.beam) mk.userData.beam.position.y = 2.05 + Math.sin(t * 3) * .14; }
  ...
  for (let i = projectiles.length - 1; i >= 0; i--) {
    ...
    const radius = p.burst ? 1.1 : .65, dmg = p.burst ? 2 : 1;
    const hitThreat = !state.debug && p.life < .95 && hitCaravanThreat(p.ball.position, radius);
    const hitTarget = !hitThreat && !state.debug && p.life < .95 && hitTrainingTarget(p.ball.position, radius, dmg);
    const hit = hitThreat || hitTarget || (!state.debug && p.life < .95 && (p.ball.position.y <= .18 || blocked(p.ball.position.x, p.ball.position.z, .25)));
    if (p.life <= 0 || hit) {
      audio.play("fireball_hit");
      burstAt(p.ball.position, p.burst ? 0xffd27a : 0xff7a1c);
      if (hitThreat) damageCaravanThreat(dmg);
...
function updateHud() {
  ...
  const areaNames = { plaza: "王都アウレリア城下町", guildHall: "冒険者ギルド会館", trainingGround: "外門練習場", academy: "王立魔法学院 講義棟", academyCampus: "王立魔法学院 キャンパス", church: "教会記録所", churchGrounds: "大聖堂 前庭", inn: "宿屋 曲がった匙亭", backstreet: "王都 裏路地", merchantOffice: "エドリック商会 事務所", administrativeStreet: "王都 行政通り", marketLodgingStreet: "王都 市場通り・宿屋周辺", forestRoad: "王都へ続く森の街道" };
