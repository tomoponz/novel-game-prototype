(() => {
  ...
  const REGIONS = [
    ...
    { g: "central", name: "市場区", manage: "商会連合", cond: "北門一時通行", needs: "なし(信用で取引拡大)", map: null, note: "現状plaza内。将来分離", unlock: (c) => c.done("gate") || c.merchantLetter },
    { g: "central", name: "住宅街/路地", manage: "王都自治/裏社会", cond: "北門一時通行", needs: "なし", map: null, note: "現状plaza内", unlock: (c) => c.done("gate") || c.merchantLetter },
    // 北
